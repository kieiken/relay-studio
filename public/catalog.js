export const platforms = [
  ...
  {id:'x',name:'X',mark:'𝕏',color:'#17191b',auto:false,browser:true,limit:280,help:'公式投稿画面を開いて投稿します。従量課金APIは使いません。反響は公式画面から記録します。',docs:'https://docs.x.com/x-api/getting-started/pricing',editor:'https://x.com/compose/post'},
  ...
  {id:'note',name:'note',mark:'n',color:'#299b84',auto:false,browser:true,limit:100000,help:'公式エディタでタイトル・本文・画像を入力して公開します。パスワードやCookieは保存しません。',editor:'https://note.com/notes/new'},
...
export const metricLabels = {impressions:'インプレッション',views:'閲覧',reach:'リーチ',likes:'いいね',comments:'コメント',replies:'返信',saved:'保存',shares:'シェア',reposts:'再投稿',quotes:'引用'};
// noteの「ページビュー」は既存の共通指標viewsで保持する。媒体ごとの表示名はapp.jsでPVにする。
export const metricKeys = {facebook:['views','likes','comments','shares'],threads:['views','likes','replies','reposts','quotes','shares'],x:['views','likes','replies','reposts'],instagram:['views','reach','likes','comments','saved','shares'],note:['impressions','views','likes','comments'],rednote:['views','likes','comments','saved','shares']};
